#!/usr/bin/env python3
"""
Script para generar gráficas de descomposición en formato JPEG con 200 DPI
...
class GeneradorDescomposicionJPEG:
    """
    Clase para generar gráficas de descomposición en formato JPEG
    """
    
    def __init__(self, ruta_datos):
        """
        Inicializar el generador con la ruta de los datos
        """
    ...
    def cargar_datos(self):
        ...
        """
        print("Cargando datos para generación de descomposición JPEG...")
    ...
    def generar_descomposicion_jpeg(self, variable):
        """
        Generar descomposición en formato JPEG con 200 DPI
        """
        print(f"\nGenerando descomposición JPEG para {variable}...")
        ...
        try:
            ...
            # Guardar en formato JPEG con 200 DPI
            ruta_jpeg = f'c:/Users/jamar/Documents/ANALISIS_SERIES_TIEMPO_10022026/results/descomposicion_completa_{variable.lower()}_200dpi.jpg'
            plt.savefig(ruta_jpeg, format='jpeg', dpi=200, bbox_inches='tight', 
                       facecolor='white', edgecolor='none')
            plt.close()
            
            print(f"  ✓ Descomposición JPEG guardada: {ruta_jpeg}")
            
            return True
            
        except Exception as e:
            print(f"Error generando descomposición JPEG para {variable}: {e}")
            return False
    
    def generar_todas_descomposiciones_jpeg(self):
        """
        Generar todas las gráficas de descomposición en formato JPEG
        """
        ...
        print("\n" + "="*60)
        print("GENERANDO GRÁFICAS DE DESCOMPOSICIÓN EN FORMATO JPEG")
        print("="*60)
        
        for variable in variables:
            self.generar_descomposicion_jpeg(variable)
        
        print("\n" + "="*60)
        print("GENERACIÓN JPEG COMPLETADA")
        print("="*60)
        print("Todas las gráficas de descomposición han sido generadas con:")
        print("- Formato JPEG")
        print("- 200 DPI")
...
def main():
    """
    Función principal para generar gráficas JPEG
    """
    ruta_datos = 'c:/Users/jamar/Documents/ANALISIS_SERIES_TIEMPO_10022026/DATA/DATA_LIMPIA.csv'
    
    # Crear generador
    generador = GeneradorDescomposicionJPEG(ruta_datos)
    
    # Generar todas las descomposiciones en JPEG
    generador.generar_todas_descomposiciones_jpeg()
